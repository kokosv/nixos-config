...

{
  ...
  options.home.modules = {
    ...
    i3-style.enable = lib.mkEnableOption "i3wm styling" // {
      default = true;
    };
    i3-session.enable = lib.mkEnableOption "i3-session proper startup" // {
      default = true;
    };
    ...
    rofi.enable = lib.mkEnableOption "application launcher" // {
      default = true;
    };
    apps.enable = lib.mkEnableOption "add tui apps to rofi" // {
      default = true;
    };
    ...
    eza.enable = lib.mkEnableOption "ls replacement" // {
      default = true;
    };
    fzf.enable = lib.mkEnableOption "tui fuzzy finder" // {
      default = true;
    };
    fusuma.enable = lib.mkEnableOption "multitouch gestures for x11" // {
      default = true;
    };
    khal.enable = lib.mkEnableOption "tui calendar" // {
      default = true;
    };
    dunst.enable = lib.mkEnableOption "notifications daemon" // {
      default = true;
    };
