{ lib, ... }: {
  options.homeManager.nvim = lib.mkOption { type = lib.types.deferredModule; };
    ...
    in
    {
      ...
      programs.nixvim = {
        ...
        */
        ...
        # Don't forget to disable the colorschemes you aren't using
        #
        ...
        # NOTE: This is where you would add a vim plugin that is not implemented in Nixvim,
        # also see extraConfigLuaPre below
